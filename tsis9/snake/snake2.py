...
FPS = 10
pygame.display.set_icon(pygame.image.load("/Users/zhansaya/Desktop/pp2/tsis9/For_snake/Snake_icon.png"))
pygame.time.set_timer(pygame.USEREVENT, 1000)
snake_position = [105, 45]
start_tick = pygame.time.get_ticks()
pygame.mixer.Channel(4).play(pygame.mixer.Sound("/Users/zhansaya/Desktop/pp2/tsis9/For_snake/Theme.mp3"))
...
def level_up(score):
    ...
    level = count+1
    if level > kek:
        pygame.mixer.Channel(3).play(pygame.mixer.Sound("/Users/zhansaya/Desktop/pp2/tsis9/For_snake/levelup.mp3"))
...
while exit:
    ...
    if snake_position[0] == fruit_position[0] and snake_position[1] == fruit_position[1]:
        ...
        level_up(score)
        fruit_spawn = False
        pygame.mixer.Channel(0).play(pygame.mixer.Sound("/Users/zhansaya/Desktop/pp2/tsis9/For_snake/Eating.mp3"))
    else:
        snake_body.pop()
    ...
    if fruit_color == yellow:
        ...
        if seconds > 4.5:
            ...
            pygame.mixer.Channel(1).play(
                pygame.mixer.Sound("/Users/zhansaya/Desktop/pp2/tsis9/For_snake/Disappearing.mp3"))
    ...
    for block in snake_body[1:]:
        if snake_position[0] == block[0] and snake_position[1] == block[1]:
            pygame.mixer.Channel(5).play(pygame.mixer.Sound("/Users/zhansaya/Desktop/pp2/tsis9/For_snake/death.mp3"))
            game_over()
