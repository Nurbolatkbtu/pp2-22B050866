...
street = pygame.image.load("/Users/zhansaya/Desktop/pp2/tsis8/pictures/Street.png")
screen.blit(street, (0, 0))

pygame.display.set_caption("Car Racing")
pygame.display.set_icon(pygame.image.load("/Users/zhansaya/Desktop/pp2/tsis8/pictures/Racing Icon.png"))

Oshiheteo = pygame.mixer.Channel(0).play(pygame.mixer.Sound("/Users/zhansaya/Desktop/pp2/tsis8/music/Eminem.mp3"))
...
Player = "/Users/zhansaya/Desktop/pp2/tsis8/pictures/White lamba.png"
Opposite = "/Users/zhansaya/Desktop/pp2/tsis8/pictures/Yellow lamba.png"
coin = "/Users/zhansaya/Desktop/pp2/tsis8/pictures/Coin.png"
...
def game_over():
    ...
    boom = pygame.image.load("/Users/zhansaya/Desktop/pp2/tsis8/pictures/boom.png")
    gameover = pygame.Surface(screen.get_size())
    gameover.fill(red)
    font = pygame.font.SysFont("", 80)
    text = font.render("GAME OVER", False, black)
    crash_sound = pygame.mixer.Sound("/Users/zhansaya/Desktop/pp2/tsis8/music/crash.wav")
...
while exit:
    ...
    if (counter > 9):
        speed -= 0.005
        pygame.mixer.Channel(3).play(pygame.mixer.Sound("/Users/zhansaya/Desktop/pp2/tsis8/pictures/manycoins.mp3"))
        counter -= 10
